...
import React, { createContext, useContext, useState, useEffect } from 'react';const SoundBoardContext = createContext();export const useSoundBoard = () => {
...
const [soundBoardHistory, setSoundBoardHistory] = useState([]);  useEffect(() => {
